...
if __name__ == "__main__":
    print("The goal of this program is to demonstrate the capabilities to generate mazes.  This uses a set maze size, definition, and input")
    x = input("Would you like to proceed? [y]es or [n]o\n")
    if x == "n" or x == "no":
        sys.exit()
    else:

...
def maze_grid_generation(size_x, size_y, walls, cell, max_y):
    ...
    maze.save(f"maze/{size_x}_x_{size_y}_{walls}_{cell}m.jpg")
    # maze.show()
...
if __name__ == "__main__":
    ...
    for _ in combinations.keys():
        ...
        maze_grid_generation(combinations[_][0], combinations[_][1], combinations[_][2], combinations[_][3], max_y)
